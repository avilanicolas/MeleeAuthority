...
public enum Attribute {
    ...
    Jab2Window("Jab 2 Window?", Float.class, false, null),
    Jab3Window("Jab 3 Window?", Float.class, false, null),
    ChDirFrames("Frames to Change Direction on Standing Turn", Float.class, true, null),
    ...
    StarDmg("Kirby Neutral+B Star Damage", Float.class, true, null),
