...
//    public final Sound sound;
    ...
    public Hitbox(byte[] data) {
        if (Animation.temp) {
            System.out.print("hitbox data: ");
            for (byte asdf : data) {
                System.out.print(String.format("%8s", Integer.toBinaryString(asdf & 0xFF)).replace(' ', '0'));
            }
            System.out.println();
        }
